...
public class ObjCrystalData
{
	...
	{
		if (type < (CtystalType)ObjCrystalData.PARAM_TBL.Length)
		{
			return ObjCrystalData.PARAM_TBL[(int)type];
		}
		return ObjCrystalData.PARAM_TBL[0];
	}
	...
	public static bool IsBig(CtystalType type)
	{
		if (type < (CtystalType)ObjCrystalData.PARAM_TBL.Length)
		{
			return ObjCrystalData.PARAM_TBL[(int)type].m_big;
		}
		return ObjCrystalData.PARAM_TBL[0].m_big;
	}
	...
	public static string GetCrystalObjectName(CtystalType type)
	{
		if (type < (CtystalType)ObjCrystalData.PARAM_TBL.Length)
		{
			return ObjCrystalData.PARAM_TBL[(int)type].m_objName;
		}
		return ObjCrystalData.PARAM_TBL[0].m_objName;
	}
}
