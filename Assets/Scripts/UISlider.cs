...
public class UISlider : UIWidgetContainer
{
	...
	private void Start()
	{
		...
		if (Application.isPlaying && this.thumb != null && this.thumb.collider != null)
		{
			...
			expr_67.onPress = (UIEventListener.BoolDelegate)Delegate.Combine(expr_67.onPress, new UIEventListener.BoolDelegate(this.OnPressThumb));
			UIEventListener expr_89 = uIEventListener;
			expr_89.onDrag = (UIEventListener.VectorDelegate)Delegate.Combine(expr_89.onDrag, new UIEventListener.VectorDelegate(this.OnDragThumb));
		}
