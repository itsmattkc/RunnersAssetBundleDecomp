...
public class ObjBossZazz1 : ObjBossEventBossBase
{
	...
	{
		ObjBossEventBossState component = base.GetComponent<ObjBossEventBossState>();
		if (component != null)
		{
			component.Init();
			int num = base.GetEventBossLevel();
			num = Mathf.Max(num, 1);
			num = Mathf.Min(num, 5);
			int num2 = base.GetEventBossHpMax();
			num2 = Mathf.Max(num2, 1);
			component.BossParam.TypeBoss = (int)this.GetBossType();
			component.BossParam.BossLevel = num;
			component.BossParam.BossHPMax = num2;
			...
			component.DebugDrawInfo(string.Concat(new object[]
			{
				"Event1 level=",
				num,
				"BossHPMax=",
				component.BossParam.BossHPMax,
				"BossDistance=",
				component.BossParam.BossDistance,
				"TableID=",
				component.BossParam.TableID
			}));
