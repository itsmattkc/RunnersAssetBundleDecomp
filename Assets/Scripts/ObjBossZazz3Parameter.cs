...
public class ObjBossZazz3Parameter : SpawnableParameter
{
	...
	public ObjBossZazz3Parameter()
	{
		...
		this.m_LV1_tblId = 0;
		this.m_LV1_attackTblId = 0;
		this.m_LV1_attackInterspace = 0.5f;
		this.m_LV1_attackWaitTime = 1.5f;
		this.m_LV1_rotSpeed = 3f;
		...
		this.m_LV2_tblId = 0;
		this.m_LV2_attackTblId = 0;
		this.m_LV2_attackInterspace = 0.5f;
		this.m_LV2_attackWaitTime = 1.5f;
		this.m_LV2_rotSpeed = 3f;
		...
		this.m_LV3_tblId = 0;
		this.m_LV3_attackTblId = 0;
		this.m_LV3_attackInterspace = 0.5f;
		this.m_LV3_attackWaitTime = 1.5f;
		this.m_LV3_rotSpeed = 3f;
		...
		this.m_LV4_tblId = 0;
		this.m_LV4_attackTblId = 0;
		this.m_LV4_attackInterspace = 0.5f;
		this.m_LV4_attackWaitTime = 1.5f;
		this.m_LV4_rotSpeed = 3f;
		...
		this.m_LV5_tblId = 0;
		this.m_LV5_attackTblId = 0;
		this.m_LV5_attackInterspace = 0.5f;
		this.m_LV5_attackWaitTime = 1.5f;
		this.m_LV5_rotSpeed = 3f;
